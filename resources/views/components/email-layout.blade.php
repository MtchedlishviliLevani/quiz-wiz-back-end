                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="background-color: #4B69FD; border-radius: 12px;">
                                        <a href="{{ $url }}" style="display: inline-block; background-color: #4B69FD; border-radius: 12px; padding: 10px 24px; color: #FFFFFF; font-weight: 600; font-family: Inter, Arial, sans-serif; font-size: 14px; text-decoration: none; width: 140px; text-align: center;">
                                            {{ $buttonText }}
                                        </a>
                                    </td>
                                </tr>
